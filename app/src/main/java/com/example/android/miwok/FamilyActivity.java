...
public class FamilyActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        WordAdapter colorAdapter = new WordAdapter(this, family, R.color.category_family);
        ...
        familyView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int position, long id) {
                ...
                releaseMediaPlayer ();
                mMediaPlayer = MediaPlayer.create(FamilyActivity.this, family.get(position).getSound());
                mMediaPlayer.start();
